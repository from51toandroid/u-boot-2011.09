...
//#define  SUNXI_USB_FASTBOOT_DEV_MAX       (255)


char sunxi_fastboot_normal_LangID[8]     = {0x04, 0x03, 0x09, 0x04, '\0'};
#define SUNXI_FASTBOOT_DEVICE_MANUFACTURER				"AW USB Developer"  		/* 厂商信息 	*/
#define SUNXI_FASTBOOT_DEVICE_PRODUCT					"AW Android Fastboot"  	/* 产品信息 	*/
#define SUNXI_FASTBOOT_DEVICE_SERIAL_NUMBER				"20080411"  			/* 产品序列号 	*/
#define SUNXI_FASTBOOT_DEVICE_CONFIG        			"Android Fastboot CFG"
...
#define	  DEVICE_PRODUCT_ID 					0x4E40
